...
const schema = z.object({
  ...
  confirmPassword: z.string().nonempty("required.").min(8, "min length is 8."),
  ...
  return (
    <div className="mb-24">
      ...
      <form onSubmit={form.onSubmit((values) => {
        ...
        <button className="text-white bg-blue-500 hover:opacity-90 mt-10 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center cursor-pointer">
          Submit
        </button>
      </form>
    </div>
